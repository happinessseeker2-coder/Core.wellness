    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            line-height: 1.9;           /* 読みやすさ重視 */
            letter-spacing: 0.05em;     /* 高級感のある字間 */
            overflow-x: hidden;
        ...
        @media (max-width: 900px) {
            ...
            .nav-menu {
                ...
                width: 70%; /* Width 70% */
                height: 100vh;
                background: rgba(10, 10, 10, 0.95); /* Semi-transparent dark */
        ...
        .hero::before {
            ...
            background: linear-gradient(to bottom, rgba(0,0,0,0.3), rgba(5,5,05,0.9));
        }
        ...
        .merit-icon { font-size: 2.2rem; /* サイズ調整 */ color: var(--accent); margin-bottom: 20px; }
        .merit-card h3 { font-size: 1.2rem; margin-bottom: 15px; color: #111; }
        .merit-card p { font-size: 0.9rem; color: #555; line-height: 1.8; margin-bottom: 0; }
        ...
        .voice-body { font-style: italic; color: #ddd; }
        ...
        .flow-step h4 { font-size: 1.2rem; margin-bottom: 10px; color: #fff; }
        ...
        .price-card {
            background: #fff; color: #333; padding: 40px; border-radius: 16px; text-align: center;
            flex: 1;
            min-width: 300px;
            max-width: 450px;
            box-shadow: 0 15px 40px rgba(0,0,0,0.1); border: 1px solid #eee;
            position: relative;
            display: flex; flex-direction: column; /* For proper button alignment */
        }
        
        /* Highlight for Advance Plan */
        .price-card.advance {
        ...
        @media (max-width: 800px) {
            .price-card.advance { transform: scale(1); }
        }

        .price-tag { 
            display: inline-block; background: #000; color: #fff; padding: 5px 15px; 
            border-radius: 20px; font-size: 0.8rem; margin-bottom: 20px; 
        }
        .price-card.advance .price-tag { background: var(--accent); color: #000; font-weight: bold; }

        .price-amount { font-size: 2.5rem; font-weight: 700; font-family: 'Montserrat', sans-serif; color: #111; }
        ...
        /* === Footer === */
        .footer { background: #000; padding: 80px 0 30px; border-top: 1px solid #222; text-align: center; }
        .footer-sns a { color: #888; font-size: 1.5rem; margin: 0 15px; }
        .footer-sns a:hover { color: var(--accent); }
        .copyright { margin-top: 40px; color: #555; font-size: 0.75rem; }
        ...
        <div class="container">
            ...
            <div style="margin-bottom: 80px;" class="fade-in">
                <div class="flow-step">
                    ...
                    <p style="font-size: 0.9rem; color:#bbb;">現状の課題と目標をヒアリングし、プランを策定します。</p>
                </div>
                <div class="flow-step">
                    <h4>Step 2. プログラム開始</h4>
                    <p style="font-size: 0.9rem; color:#bbb;">週1回のセッションと、毎日のLINEサポートで伴走します。</p>
                </div>
                <div class="flow-step">
                    <h4>Step 3. 卒業・自走</h4>
                    <p style="font-size: 0.9rem; color:#bbb;">ご自身でコントロールできる状態を目指し、卒業となります。</p>
                </div>
            </div>
