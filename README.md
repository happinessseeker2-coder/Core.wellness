...
<head>
    ...
    <link rel="icon" type="image/png" href="/Core.wellness/favicon.png">
    <link rel="apple-touch-icon" href="/Core.wellness/favicon.png">
...
<section class="hero">
    <div class="hero-content" style="text-align: center;">
        ...
        <h1 class="hero-title fade-in" style="text-align: center;">
            ...
            <span style="display: inline-block; border: 2px solid #5D7266; padding: 30px; margin-top: 10px; font-size: 0.6em; font-weight: 500; line-height: 1.8; color: var(--text-main); border-radius: 8px;">
                3ヶ月で、栄養の基礎から“本質の応用”まで確実に身につく。<br>
                点の知識ではなく、何を選び、なぜ選ぶかまで説明できるインストラクターへ。<br>
                動きと栄養を一貫して導ける力を手に入れ、<br>
                より多くの顧客を手に入れましょう。
            </span>
        </h1>
            ...
            <div class="voices-grid fade-in">
                ...
                <div class="voice-card">
                    ...
                    <div class="voice-body">
                        「身体の使い方は分かっているつもりでしたが、指導で自分の癖を根本から修正できました。クライアントへのキューイングの質も上がり、自信がつきました。」
                    </div>
                </div>
                ...
                <div class="voice-card">
                    ...
                    <div class="voice-body">
                        「食事指導が苦手でしたが、おかげで理論的にアドバイスできるようになりました。生徒さんのダイエット成功率が上がり、継続率もアップしています！」
                    </div>
                </div>
